...
public class Nhasanxuat implements Serializable {
	...
	@OneToMany(fetch=FetchType.LAZY,cascade=CascadeType.ALL,mappedBy="nhasanxuat")
	@JsonIgnore
	private List<Thietbiyte> thietbiyte;
	@OneToMany(fetch=FetchType.LAZY,cascade=CascadeType.ALL,mappedBy="nhasanxuat")
	@JsonIgnore
    ...
    public List<Thietbiyte> getThietbiyte() {
		return thietbiyte;
	}

	public void setThietbiyte(List<Thietbiyte> thietbiyte) {
